        ...
        function ($stateProvider, $urlRouterProvider) {
            $stateProvider
                .state("login", {
                    ...
                    resolve: {
                        allServers: ['resource', '$rootScope',
                            function (resource, $rootScope) {
                                return  resource.query(globalUrl + '/cheungssh/groupinfoall/').then(function (data) {
                        ...
                        'contentPanel': {
                            resolve: {
                                keyFileList: ['resource', '$rootScope',
                                    function (resource, $rootScope) {
                                        return resource.query(globalUrl + '/cheungssh/keyadmin/?show_type=list').then(function (data) {
                    ...
                    views: {
                        'contentPanel': {
                            templateUrl: '../template/visitHistory.tpl.html',
    ...
    .factory('resource', ['$q', 'cfpLoadingBar', '$state', '$rootScope', function ($q, cfpLoadingBar, $state, $rootScope) {
        ...
        return{
            query: function (url) {
                ...
                ajaxCount++;
                var query = version == 'dev'? $.jsonp: $.ajax;
                query({
                    url: url,
                    type:'get',
